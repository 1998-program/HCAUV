...
void AC_AttitudeControl::control_monitor_update(void)
{
    ...
    control_monitor_filter_pid(iroll.P,  _control_monitor.rms_roll_P);
    ...
    control_monitor_filter_pid(ipitch.P ,  _control_monitor.rms_pitch_P);
    ...
    control_monitor_filter_pid(iyaw.P + iyaw.D ,  _control_monitor.rms_yaw);
}
